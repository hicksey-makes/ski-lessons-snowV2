    ...
    return ( <>
      ...
      <div className="container">
        ...
        {this.props.lessons.map(item => {
          return <ListLesson  key={item.lsnId} lsns={item} toggleAdd={this.props.toggleAdd} reserveLsn={this.props.reserveLsn} onLessonSelect={this.props.onLessonSelect} cart={this.props.cart} onProductDelete={this.props.onProductDelete} />
        })}
      </div>
    </>);
  }
